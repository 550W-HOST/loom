...
export const AUTOMATIONS_ROUTE_PATH = LEGACY_AUTOMATIONS_ROUTE_PATH;
export const AUTOMATIONS_BROWSE_ROUTE_PATH = `${AUTOMATIONS_ROUTE_PATH}/browse`;
export const AUTOMATION_DETAIL_ROUTE_PATH = `${AUTOMATIONS_ROUTE_PATH}/:projectId/:automationId`;
export const AUTOMATION_EDIT_ROUTE_PATH = `${AUTOMATION_DETAIL_ROUTE_PATH}/edit`;
